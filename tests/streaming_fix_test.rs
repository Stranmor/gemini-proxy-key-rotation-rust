...
fn test_streaming_detection_works() {
    ...
    assert!(is_streaming_request(&body_bytes), "Should detect streaming request");
    ...
    assert!(!is_streaming_request(&body_bytes), "Should detect non-streaming request");
    ...
    assert!(!is_streaming_request(&body_bytes), "Should default to non-streaming");
}