...
mod tests {
    ...
    async fn test_metrics_collector_basic_operations() {
        ...
        collector
            .record_request_success(Duration::from_millis(100), "key1")
            .await;
        collector
            .record_request_failure("timeout", Some("key2"))
            .await;
    ...
    async fn test_prometheus_export() {
        ...
        collector.record_request_start();
        collector
            .record_request_success(Duration::from_millis(50), "test_key")
            .await;
        ...
        assert!(
            prometheus_output.contains("gemini_proxy_key_usage_total{key_preview=\"test_key\"} 1")
        );
